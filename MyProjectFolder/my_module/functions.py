...
from IPython.display import clear_output   # clears previous output, allowing each "frame" to overlay
                                           # one another, and allows the appearance of movement(animation)
...
class Point:
    ...
    get_x(self)
    get_y(self)
    set_coordinate(self, x_coord, y_coord)
